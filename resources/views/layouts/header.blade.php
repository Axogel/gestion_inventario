<!--app header-->
						<div class="app-header header top-header">
							...
							@endif				
											...
											<a href="{{ route('inventario.edit', ['id' => $producto->id]) }}" class="dropdown-item d-flex pb-3">
													...
													<div>
														...
														<div class="small text-muted">Tienes x{{$producto->stock}} Presiona aqui para reponer</div>
													</div>
												</a>
											@endforeach
											</div>
